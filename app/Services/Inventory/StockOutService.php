 ...
 * measure / conversion / average-cost-based pricing — PRODUCT and COMBO
 * (the pre-existing, Node-owned catalogs) are tracked as plain counts with
 * no cost on the movement.
 */
